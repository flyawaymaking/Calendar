...
Плагин для серверов Minecraft Paper, который автоматически выдает награды игрокам за количество дней входа на сервер в течение месяца. Идеально подходит для повышения ежедневной активности игроков!

## 🧩 Совместимость с версиями

| **Версия плагина** | **Поддерживаемые Paper** | **Java** |
|--------------------|--------------------------|----------|
| `1.3.0`            | `1.20.6` – `26.2`        | 25       |
| `1.2.0`            | `1.20.6` – `1.21.11`     | 21       |
